...
__all__ = ['DenseNet', 'densenet21', 'densenet121', 'densenet169', 'densenet201', 'densenet264']
...
class DenseNet(nn.Module):
    ...
    def forward(self, x):
        ...
        #out = F.avg_pool3d(out, kernel_size=(5, 6, 5)).view(features.size(0), -1)   
        jxy = out.view(features.size(0), -1)
        #out = self.dropout(out)
        out = self.classifier(jxy)
